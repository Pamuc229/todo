        ...
        <div class="padding">
            <div class="row container d-flex justify-content-center">
                <div class="col-md-12">
                    <div class="card px-3">
                        <div class="card-body">
                            <h4 class="card-title">Ввведите ваши задачи</h4>
                            <div class="add-items d-flex">
                                <form action="{{ route('store') }}" method="POST">
                                    @csrf
                                    <textarea type="text" class="form-control todo-list-input" name="quest" id="quest" placeholder="Что хотите сделать?"></textarea>
                                    <button type="submit" class="add btn btn-primary font-weight-bold todo-list-add-btn">Добавить</button>
                            </div>
                            </form>
                            @if (count($quests))
                            <ul>
                                ...
                                <li>
                                    <form action="{{ route('destroy', $quest->id) }}" method="POST">
                                        {{ $quest->quest}}
                                        @csrf
                                        @method('get')
                        ...
                        @if (count($quests))
                        <div>
                            У вас всего {{ DB::table('quests')->where('user_id','=',Auth::user()->id)->count() }} задач!
                        </div>
                        @endif
                    </div>
                </div>
